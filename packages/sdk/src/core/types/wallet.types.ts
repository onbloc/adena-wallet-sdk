...
export enum WalletResponseSuccessType {
  ...
  CREATE_MULTISIG_TRANSACTION_SUCCESS = 'CREATE_MULTISIG_TRANSACTION',
  SIGN_MULTISIG_TRANSACTION_SUCCESS = 'SIGN_MULTISIG_TRANSACTION',
  BROADCAST_MULTISIG_TRANSACTION_SUCCESS = 'BROADCAST_MULTISIG_TRANSACTION',
...
export enum WalletResponseFailureType {
  ...
  CREATE_MULTISIG_TRANSACTION_FAILED = 'CREATE_MULTISIG_TRANSACTION_FAILED',
  SIGN_MULTISIG_TRANSACTION_FAILED = 'SIGN_MULTISIG_TRANSACTION_FAILED',
  ...
  BROADCAST_MULTISIG_TRANSACTION_FAILED = 'BROADCAST_MULTISIG_TRANSACTION_FAILED',
...
export enum WalletResponseRejectType {
  ...
  CREATE_MULTISIG_TRANSACTION_REJECTED = 'CREATE_MULTISIG_TRANSACTION_REJECTED',
  SIGN_MULTISIG_TRANSACTION_REJECTED = 'SIGN_MULTISIG_TRANSACTION_REJECTED',
  BROADCAST_MULTISIG_TRANSACTION_REJECTED = 'BROADCAST_MULTISIG_TRANSACTION_REJECTED',
...
> = {
  ...
  CREATE_MULTISIG_TRANSACTION: {
    code: 0,
    status: WalletResponseStatus.SUCCESS,
    type: WalletResponseSuccessType.CREATE_MULTISIG_TRANSACTION_SUCCESS,
    message: 'Multisig document has been successfully created.',
  },
  SIGN_MULTISIG_TRANSACTION: {
    code: 0,
    status: WalletResponseStatus.SUCCESS,
    type: WalletResponseSuccessType.SIGN_MULTISIG_TRANSACTION_SUCCESS,
    message: 'Signature hash has been successfully generated.',
  },
  BROADCAST_MULTISIG_TRANSACTION: {
    code: 0,
    status: WalletResponseStatus.SUCCESS,
    type: WalletResponseSuccessType.BROADCAST_MULTISIG_TRANSACTION_SUCCESS,
    message: 'Multisig Transaction has been successfully executed.',
  },
  ADD_NETWORK_SUCCESS: {
    code: 0,
    status: WalletResponseStatus.SUCCESS,
...
> = {
  ...
  CREATE_MULTISIG_TRANSACTION_FAILED: {
    code: 4001,
    status: WalletResponseStatus.FAILURE,
    type: WalletResponseFailureType.CREATE_MULTISIG_TRANSACTION_FAILED,
    message: 'Adena could not create the multisig document.',
  },
  SIGN_MULTISIG_TRANSACTION_FAILED: {
    code: 4001,
    status: WalletResponseStatus.FAILURE,
    type: WalletResponseFailureType.SIGN_MULTISIG_TRANSACTION_FAILED,
    message: 'Adena could not generate the signature hash.',
  },
  BROADCAST_MULTISIG_TRANSACTION_FAILED: {
    code: 4001,
    status: WalletResponseStatus.FAILURE,
    type: WalletResponseFailureType.BROADCAST_MULTISIG_TRANSACTION_FAILED,
    message: 'Adena could not execute the multisig transaction.',
  },
  ALREADY_CONNECTED: {
    code: 4001,
    status: WalletResponseStatus.FAILURE,
...
> = {
  ...
  CREATE_MULTISIG_TRANSACTION_REJECTED: {
    code: 4000,
    status: WalletResponseStatus.FAILURE,
    type: WalletResponseRejectType.CREATE_MULTISIG_TRANSACTION_REJECTED,
  ...
  BROADCAST_MULTISIG_TRANSACTION_REJECTED: {
    code: 4000,
    status: WalletResponseStatus.FAILURE,
    type: WalletResponseRejectType.BROADCAST_MULTISIG_TRANSACTION_REJECTED,
    message: 'The multisig transaction has been rejected by the user.',
  },
  CONNECTION_REJECTED: {
    code: 4000,
    status: WalletResponseStatus.FAILURE,
...
> = {
  ...
  CREATE_MULTISIG_TRANSACTION: {
    code: 0,
    status: WalletResponseStatus.SUCCESS,
    type: WalletResponseExecuteType.CREATE_MULTISIG_TRANSACTION,
    message: 'Create Multisig Document',
  },
  SIGN_MULTISIG_TRANSACTION: {
    code: 0,
    status: WalletResponseStatus.SUCCESS,
    type: WalletResponseExecuteType.SIGN_MULTISIG_TRANSACTION,
    message: 'Sign Document',
  },
  BROADCAST_MULTISIG_TRANSACTION: {
    code: 0,
    status: WalletResponseStatus.SUCCESS,
    type: WalletResponseExecuteType.BROADCAST_MULTISIG_TRANSACTION,
    message: 'Broadcast Multisig Transaction',
  },
  ADD_NETWORK: {
    code: 0,
    status: WalletResponseStatus.SUCCESS,
